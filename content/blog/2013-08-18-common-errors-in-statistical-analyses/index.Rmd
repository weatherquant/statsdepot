...
This issue is not so much an issue of poor statistics but rather of poor placement of emphasis. It is very well explained by Peter Attia [here](http://eatingacademy.com/nutrition/irisin-the-magic-exercise-hormone), so I'll not elaborate on it any further here.
...
Figure \@ref(fig:figure1) shows the relationship between *x* and *y*. As indicated by the correlation analysis, knowing *x* doesn't really tell us anything about *y*.

(ref:figure1) Relationship between *x* and *y* in our made-up example dataset.

```{r figure1, echo = FALSE, out.width = "75%", fig.cap = '(ref:figure1)'}
...
In this example, we chose 10 quantiles. The resulting graph is shown in Figure \@ref(fig:figure2).

(ref:figure2) Mean *y* (+/- standard error) as a function of quantiles of *x*.

```{r figure2, echo = FALSE, out.width = "75%", fig.cap = '(ref:figure2)'}
...
Finally, the exact same data look quite different depending on the exact number of quantiles. Figure \@ref(fig:figure3) shows the same data presented with 6 quantiles.

(ref:figure3) Mean *y* (+/- standard error) as a function of quantiles of *x*. Now using 6 instead of 10 quantiles.

```{r figure3, echo = FALSE, out.width = "75%", fig.cap = '(ref:figure3)'}
knitr::include_graphics("./Fig3.png")
```

And Figure \@ref(fig:figure4) shows the same data presented with 20 quantiles.


(ref:figure4) Mean *y* (+/- standard error) as a function of quantiles of *x*. Now using 20 instead of 10 quantiles.

```{r figure4, echo = FALSE, out.width = "75%", fig.cap = '(ref:figure4)'}
